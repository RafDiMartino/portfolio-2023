...
export const Hero = () => {
    return (
        <section className={classes.heroSection}>
            <div className={classes.nameAboutWrapper}>
                <div className={classes.fullName}>
                    <p className={classes.name}>RAFFAELE</p>
                    <p className={classes.surname}>DI MARTINO</p>
                </div>
                <div className={classes.aboutWrapper}>
                    <p className={classes.about}>Frontend Developer with an Art & Design background </p>
                </div>
            </div>
            <div className={classes.socialWrapper}>
                <Link className={`${classes.social} ${classes.linkedin}`} href="https://www.linkedin.com/in/raffaele-di-martino/" target="_blank">
                    <svg width="16" height="16" viewBox="0 0 52 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.8343 5.54348C10.8343 8.64783 8.45098 11.087 5.41764 11.087C2.38431 11.087 0.000976562 8.64783 0.000976562 5.54348C0.000976562 2.43913 2.38431 0 5.41764 0C8.45098 0 10.8343 2.43913 10.8343 5.54348ZM10.8343 15.5217H0.000976562V51H10.8343V15.5217ZM28.1676 15.5217H17.3343V51H28.1676V32.3739C28.1676 21.9522 41.1676 21.0652 41.1676 32.3739V51H52.001V28.6043C52.001 11.087 32.7176 11.7522 28.1676 20.4V15.5217Z" fill="#C09E6B" />
                    </svg>
                </Link>
                <Link className={`${classes.social} ${classes.github}`} href="https://github.com/RafDiMartino" target="_blank">
